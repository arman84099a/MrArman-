...
async def get_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("MrArman/assets/circle.png")
            ...
            # fonts
            font1 = ImageFont.truetype('MrArman/assets/font.ttf', 30)
            font2 = ImageFont.truetype('MrArman/assets/font2.ttf', 70)
            font3 = ImageFont.truetype('MrArman/assets/font2.ttf', 40)
            font4 = ImageFont.truetype('MrArman/assets/font2.ttf', 35)

            image4 = ImageDraw.Draw(image2)
            image4.text((10, 10), "ARMAN x MUSIC", fill="white", font = font1, align ="left") 
